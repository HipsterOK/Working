...
import ru.porcupine.economyquiz.activities.InfoActivity
import ru.porcupine.economyquiz.activities.MainActivity
import ru.porcupine.economyquiz.activities.MenuActivity
import ru.porcupine.economyquiz.activities.ResultsActivity
...
class NewIntents {
    ...
    fun newIntentResult(context: Context, score:Int){
        val resultActivity = Intent(context, ResultsActivity::class.java)
