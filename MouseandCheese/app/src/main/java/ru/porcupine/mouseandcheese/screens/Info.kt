...
class Info {
    ...
    fun Text(gameController: GameController) {
        Text(
            text = "Welcome!\n" +
                    "Your goal is to guide the mouse through the mousetraps, but you don't know which mousetrap will get the cheese.\n" +
                    "There are 2 cheeses in each row, if you guessed right, then your points increase by 1.5 times, and also restores one health. And if you have not guessed correctly, then you lose one life.\n" +
                    "Good luck",
