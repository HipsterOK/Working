...
class InfoScreen {
    ...
    fun Text(controller: Controller) {
        Text(
            text = "Welcome!\n" +
                    "Tap the screen to eat candy and earn points by playing for the boy until his mom sees him.\n" +
                    "Mom appears in several stages, when she looks out slightly, she does not see you, but is preparing to go to the middle, where she will already be able to notice you.\n" +
                    "Good luck!",
