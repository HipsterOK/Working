...
import ru.porcupine.petthedog.logic.UpgradeController
...
class MainActivity : ComponentActivity() {
    ...
    fun Dog(mainLogic: MainLogic){
        val height by animateDpAsState(targetValue = mainLogic.dogHeight.dp)
        val width by animateDpAsState(targetValue = mainLogic.dogWidth.dp)
        Image(
            ...
            Row(
                ...
                Row(
                    ...
                    Image(
                        ...
                        contentDescription = "heart",
                        modifier = Modifier
                            .size((mainLogic.heartSize / 1.5).dp)
