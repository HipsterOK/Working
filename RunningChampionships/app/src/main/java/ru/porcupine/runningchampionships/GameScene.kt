...
import ru.porcupine.runningchampionships.models.CloudState
import ru.porcupine.runningchampionships.models.EarthState
import ru.porcupine.runningchampionships.models.*
import ru.porcupine.runningchampionships.ui.theme.*
...
fun MainGameScene(gameState: GameState, context:Context) {
    ...
    val vector1 = ImageVector.vectorResource(id = R.drawable.ic_enemy)
