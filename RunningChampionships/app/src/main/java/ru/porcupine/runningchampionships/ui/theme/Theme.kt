package ru.porcupine.runningchampionships.ui.theme
...
val Colors.backColor: Color
    get() = if (isLight) Color(0xFF41B3FF) else Color(0xFF67C2FD)

val Colors.earthColor: Color
    get() = if (isLight) Color(0xFFC46642) else Color(0xFFBE6440)
